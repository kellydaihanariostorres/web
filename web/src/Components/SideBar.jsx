          ...
          {!storage.get('authUser') ? (
            <div className='collapse navbar-collapse navbar-dark bg-dark' id='nav'>  
              ...
              <ul className='navbar-nav flex-column mb-2'>
                ...
                <li className='nav-item'>
                  <NavLink to='/clientes' className='text-white rounded py-2 w-100 d-inline-block px-2'><FaIcons.FaQq  className='me-3'/>
                    CLIENTES
                  </NavLink>
                </li>
                <li className='nav-item'>
                  <NavLink to='/empleado' className='text-white rounded py-2 w-100 d-inline-block px-2'><FaIcons.FaPray  className='me-2'/>
                    EMPLEADOS
                  </NavLink>
                </li>
                <li className='nav-item'>
                  <NavLink to='/productos' className='text-white rounded py-2 w-100 d-inline-block px-2'><FaIcons.FaArchive className='me-2'/>
                    PRODUCTOS
                  </NavLink>
                </li>
                <li className='nav-item'>
                ...
                <li className='nav-item'>
                  <NavLink to='/caja' className='text-white rounded py-2 w-100 d-inline-block px-2'><FaIcons.FaBarcode className='me-2'/>
                    CAJA
                  </NavLink>
                </li>
                <li className='nav-item'>
                ...
                <li className='nav-item'>
                  <NavLink to='/inventario' className='text-white rounded py-2 w-100 d-inline-block px-2'><FaIcons.FaClipboard className='me-2'/>
                    INVENTARIO
                  </NavLink>
                </li>
              </ul>
